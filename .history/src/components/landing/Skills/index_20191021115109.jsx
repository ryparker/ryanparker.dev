	...
	<Wrapper id="about">
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<p>
					Sometimes automation is not always the answer. I've found that by providing ways to trigger deploys from slack, developers and testers become more self sufficient and less reliant on automation triggers.
				</p>
