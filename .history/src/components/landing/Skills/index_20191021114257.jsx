	...
	<Wrapper id="about">
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<p>
					Making basic development resources more accessible can sometimes provide more benefit than automation. I've found that providing a way to trigger deploys from slack has helped developers and testers to be more self sufficient.
				</p>
