	...
	<Wrapper id="about">
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<h2>Testing</h2>
				<ul>
					<li>REST API test suites that assert functionality, performance, security, and data structure.</li>
					<li>SOAP API test suites that assert functionality, performance, security, and data structure.</li>
				...
				<h2>Documentation</h2>
				<ul>
					<li>Developed a plugin for grails that generates openAPI3 documentation.</li>
