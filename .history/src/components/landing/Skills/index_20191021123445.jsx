		...
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<ul>
					...
					<li>Enable anyone with the ability to kick off automated test suites.</li>
				</ul>
				<h2>Testing</h2>
				<ul>
				...
				<ul>
					...
					<li>API documentation for integration partners.</li>
					<li>Process documentation for automation.</li>
				</ul>
