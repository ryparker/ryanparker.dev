	...
	<Wrapper id="about">
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<p>
					Making basic development resources more accessible can sometimes provide more benefit than automation. I've found that by providing ways to trigger deploys from slack, developers and testers become more self sufficient.
				</p>
