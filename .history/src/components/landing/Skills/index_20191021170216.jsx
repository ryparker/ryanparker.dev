	...
	<Wrapper id="about">
		<SkillsWrapper as={Container}>
			...
			<Details>
				...
				<h2>Automation</h2>
				<ul>
					<li data-sal="slide-left" data-sal-duration="30000" data-sal-delay="30000" data-sal-easing="ease">Restructured and automated Jira to reflect development in real time.</li>
